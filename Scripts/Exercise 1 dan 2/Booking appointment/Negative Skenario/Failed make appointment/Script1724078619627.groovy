...
'Memastikan label appointment confirmation tidak muncul'
WebUI.verifyElementNotPresent(findTestObject('Page_makeAppointment/label_appointmentConfirmation'), 0)

'Melakukan screenshot gagal membuat appointment'
WebUI.takeScreenshot('screenshot/GagalMembuatAppointment.png')

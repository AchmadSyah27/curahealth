...
WebUI.sendKeys(findTestObject('Page_Login/textbox_username'), 'Mail lee')

'Melakukan input pada textbox password'
WebUI.sendKeys(findTestObject('Page_Login/textbox_password'), '')
...
WebUI.verifyElementPresent(findTestObject('Page_Login/label_loginGagal'), 0)

'Melakukan screenshot login gagal'
